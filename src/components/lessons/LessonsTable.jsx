        ...
        <table className="table w-full border-collapse min-w-[700px] lg:min-w-0">
          ...
          <tbody className="divide-y-2 divide-[#1C1611]">
            {TABLE_LESSONS.map((row) => (
              <tr key={row.id} className="hover:bg-[#1C1611]/5 transition-colors duration-100 group bg-[#F6F0DD]">
                <td className="p-5 flex items-center gap-4 min-w-0 border-r-[2px] border-[#1C1611]">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black border-2 border-[#1C1611] shrink-0 shadow-[2px_2px_0px_0px_#1C1611] ${row.iconBg} text-[#1C1611]`}>
                    {row.title.charAt(0)}
                  </div>
                ...
                <td className="p-5 whitespace-nowrap border-r-[2px] border-[#1C1611]">
                  <div className="flex items-center gap-4 text-xs font-black text-[#1C1611]/80">
                    <span className="flex items-center gap-1.5">
                      <Heart className="w-4 h-4 stroke-[2.5px]" /> {row.likes}
                    </span>
                    <span className="flex items-center gap-1.5">
                      <Bookmark className="w-4 h-4 stroke-[2.5px]" /> {row.saves}
                    </span>
                  </div>
                </td>
